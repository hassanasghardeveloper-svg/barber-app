        ...
        <main className="min-h-screen bg-slate-950 pt-32 pb-20">
            ...
            <div className="container mx-auto px-6 max-w-3xl">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-400">Everything you need to know about Premium Cuts.</p>
                </div>

                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 mb-12">
                    <Accordion type="single" collapsible className="w-full">
                        {faqs.map((faq, i) => (
                            <AccordionItem key={i} value={`item-${i}`} className="border-b border-slate-800 last:border-0">
                ...
                <div className="text-center bg-amber-500/10 border border-amber-500/20 p-8 rounded-3xl">
                    ...
                    <p className="text-slate-400 mb-6">We're here to help.</p>
                    <Link href="/contact">
